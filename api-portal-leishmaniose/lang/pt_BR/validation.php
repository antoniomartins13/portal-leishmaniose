...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de Linguagem de Validação Customizada
    |--------------------------------------------------------------------------
    |
    ...
    | Isso torna rápido especificar uma linha de linguagem customizada
    | específica para uma regra de atributo fornecida.
    |
    */

    'custom' => [
        'role' => [
            'in' => 'O grupo selecionado é inválido. Escolha entre: admin, gestor ou pesquisador.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para substituir nosso
    | placeholder de atributo por algo mais amigável ao leitor, como
