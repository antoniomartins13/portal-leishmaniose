        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-teal-100">
              Uma iniciativa para monitoramento e controle da Leishmaniose no
              Brasil.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/sobre" className="text-teal-100 hover:text-white">
                  Sobre a Doença
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/painel" className="text-teal-100 hover:text-white">
                  Painel Público
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/noticias" className="text-teal-100 hover:text-white">
                  Notícias
                </Link>
              </li>
              <li>
